    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to American Medical Services, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using American Medical Services, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          American Medical Services is designed to simplify healthcare access. You can choose
